...
Beyond research, I led [**Argus**]({{ '/projects/a2_argus_cubesat/' | relative_url }}), a small satellite mission demonstrating the use of onboard GPUs for vision-based navigation. I oversaw the development and testing of hardware and software across all subsystems, from spacecraft architecture to mission integration. I also contributed to the [GNC stack of PY4](https://digitalcommons.usu.edu/cgi/viewcontent.cgi?article=5862&context=smallsat), a satellite mission successfully launched into orbit aboard SpaceX Transporter-10 on March 4, 2024!
